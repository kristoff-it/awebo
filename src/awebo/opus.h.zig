...
pub const OPUS_RESTRICT = @compileError("unable to translate C expr: unexpected token 'restrict'");
// ./opus_defines.h:98:10
pub const OPUS_INLINE = @compileError("unable to translate C expr: unexpected token 'inline'");
// ./opus_defines.h:110:10
pub const OPUS_WARN_UNUSED_RESULT = @compileError("unable to translate macro: undefined identifier `__warn_unused_result__`");
// ./opus_defines.h:117:10
pub const OPUS_ARG_NONNULL = @compileError("unable to translate macro: undefined identifier `__nonnull__`");
// ./opus_defines.h:122:10
...
pub inline fn __opus_check_int(x: anytype) opus_int32 {
    _ = &x;
    return blk_1: {
        _ = @import("std").zig.c_translation.cast(anyopaque, x == @import("std").zig.c_translation.cast(opus_int32, @as(c_int, 0)));
        break :blk_1 @import("std").zig.c_translation.cast(opus_int32, x);
    };
}
pub inline fn __opus_check_int_ptr(ptr: anytype) @TypeOf(ptr + (ptr - @import("std").zig.c_translation.cast([*c]opus_int32, ptr))) {
    _ = &ptr;
    return ptr + (ptr - @import("std").zig.c_translation.cast([*c]opus_int32, ptr));
}
pub inline fn __opus_check_uint_ptr(ptr: anytype) @TypeOf(ptr + (ptr - @import("std").zig.c_translation.cast([*c]opus_uint32, ptr))) {
    _ = &ptr;
    return ptr + (ptr - @import("std").zig.c_translation.cast([*c]opus_uint32, ptr));
}
pub inline fn __opus_check_uint8_ptr(ptr: anytype) @TypeOf(ptr + (ptr - @import("std").zig.c_translation.cast([*c]opus_uint8, ptr))) {
    _ = &ptr;
    return ptr + (ptr - @import("std").zig.c_translation.cast([*c]opus_uint8, ptr));
}
pub const __opus_check_val16_ptr = @compileError("unable to translate macro: undefined identifier `opus_val16`");
// ./opus_defines.h:195:9
pub inline fn __opus_check_void_ptr(x: anytype) @TypeOf(x) {
    _ = &x;
    return blk_1: {
        _ = @import("std").zig.c_translation.cast(anyopaque, @import("std").zig.c_translation.cast(?*anyopaque, @as(c_int, 0)) == x);
        break :blk_1 x;
    };
}
